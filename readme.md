...
Ett repo för macOS-appar och deras installationsfiler (DMG). Här samlas färdigbyggda appar och distributionspaket redo för installation.
...
A repository for macOS apps and their installer files (DMG). Contains built apps and distribution packages ready for installation.
